...
// Admin-only methods (getAdminMe, admin*, listAdminRoles, etc.) have been
// removed from this interface — they now live only in
// artifacts/salvageme-admin/src/lib/api-client.ts, a separate, unshared
// copy. See admin-app-isolation-plan.md.
